...
# def re_re_modify(new_lines,result):
#     compound_result=find_compound_line(new_lines)



def main_compound(input_folder_path, output_folder_path):
    # print(new_lines)
    # output_file_path= "output8bhjb.txt"
...
if __name__ == "__main__":
    main_compound("input", 'compound_outputs')